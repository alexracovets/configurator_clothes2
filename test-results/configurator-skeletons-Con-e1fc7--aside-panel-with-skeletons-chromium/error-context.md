...
- Name: configurator-skeletons.spec.ts >> Configurator skeleton dimensions >> switching design pattern does not replace aside panel with skeletons
- Location: playwright\configurator-skeletons.spec.ts:31:7
