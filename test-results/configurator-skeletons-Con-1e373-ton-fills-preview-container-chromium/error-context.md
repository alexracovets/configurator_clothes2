...
- Name: configurator-skeletons.spec.ts >> Configurator skeleton dimensions >> pattern preview skeleton fills preview container
- Location: playwright\configurator-skeletons.spec.ts:49:7
...
Locator: getByTestId('skeleton-pattern-preview').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('skeleton-pattern-preview').first()
