...
- Name: configurator-skeletons.spec.ts >> Configurator skeleton dimensions >> design step skeleton pattern tiles are 80px tall
- Location: playwright\configurator-skeletons.spec.ts:36:7
...
Locator: getByTestId('skeleton-step-design')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('skeleton-step-design')
