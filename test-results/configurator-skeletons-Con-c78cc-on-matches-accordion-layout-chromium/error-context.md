...
- Name: configurator-skeletons.spec.ts >> Configurator skeleton dimensions >> color step skeleton matches accordion layout
- Location: playwright\configurator-skeletons.spec.ts:28:7
...
Locator: getByTestId('skeleton-step-accordion')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('skeleton-step-accordion')
