...
- Name: configurator-skeletons.spec.ts >> Configurator skeleton dimensions >> logo upload skeleton matches dropzone height
- Location: playwright\configurator-skeletons.spec.ts:71:7
...
Locator: getByTestId('skeleton-logo-upload')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('skeleton-logo-upload')
