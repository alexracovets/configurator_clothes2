...
import type { PrintablePartMeshes, PrintGizmoElement } from '@gizmo';
...
const PrintGizmoInstance = memo(({ element, elements, printableParts, gizmoStep, selectedInstanceId }: PrintGizmoInstanceProps) => {
