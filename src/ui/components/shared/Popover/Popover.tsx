...
import { getStrictContext } from '@providers';
...
function PopoverPortal(props: PopoverPortalProps) {
  ...
  return <AnimatePresence>{isOpen && <PopoverPrimitive.Portal forceMount data-slot="popover-portal" {...props} />}</AnimatePresence>;
}

type PopoverContentProps = Omit<React.ComponentProps<typeof PopoverPrimitive.Content>, 'forceMount'> & HTMLMotionProps<'div'>;
