const garmentNumberMapFragment = /* glsl */ `
  vec2 numberStampUv0 = garmentNumberToStampUv( vPrintUv, uNumberAnchorUv[0], uNumberRotation[0], uNumberScale[0] );
  vec2 numberStampUv1 = garmentNumberToStampUv( vPrintUv, uNumberAnchorUv[1], uNumberRotation[1], uNumberScale[1] );
  vec2 numberStampUv2 = garmentNumberToStampUv( vPrintUv, uNumberAnchorUv[2], uNumberRotation[2], uNumberScale[2] );
  vec2 numberStampUv3 = garmentNumberToStampUv( vPrintUv, uNumberAnchorUv[3], uNumberRotation[3], uNumberScale[3] );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[0], uNumberScale[0], uNumberGizmoHalf[0], uNumberGizmoEnabled * uNumberGizmoFrameActive[0], numberInside0 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[1], uNumberScale[1], uNumberGizmoHalf[1], uNumberGizmoEnabled * uNumberGizmoFrameActive[1], numberInside1 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[2], uNumberScale[2], uNumberGizmoHalf[2], uNumberGizmoEnabled * uNumberGizmoFrameActive[2], numberInside2 ) );
  ...
  printColor = garmentCompositeUiLayer( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[3], uNumberScale[3], uNumberGizmoHalf[3], uNumberGizmoEnabled * uNumberGizmoFrameActive[3], numberInside3 ) );
`;
