...
let hoverTarget: GizmoButtonHoverTarget | null = null;
let dragTarget: GizmoButtonHoverTarget | null = null;
...
const setGizmoButtonHover = (target: GizmoButtonHoverTarget | null) => {
  const unchanged =
...
const setGizmoButtonDragActive = (target: GizmoButtonHoverTarget | null) => {
  const unchanged =
